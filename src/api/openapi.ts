export const OPENAPI_DOCUMENT = Object.freeze({
  ...
  paths: {
    ...
    "/v1/account/recovery-codes": { post: { description: "Replace the account's eight one-time recovery codes after recent reauthentication", requestBody: { required: true, content: { "application/json": { schema: { "$ref": "#/components/schemas/EmptyRequest" } } } }, responses: { "200": { description: "Recovery codes returned once" }, "401": { description: "Recent reauthentication required" } } } },
