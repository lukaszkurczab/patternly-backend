...
export const OPENAPI_DOCUMENT = Object.freeze({
  ...
  paths: {
    ...
    "/v1/progress/sync": { post: { requestBody: { required: true, content: { "application/json": { schema: { "$ref": "#/components/schemas/SyncRequest" } } } }, responses: { "200": { description: "Applied or duplicate mutations" }, "400": { description: "Invalid sync request, fingerprint, or track bundle" }, "409": { description: "Progress or account revision conflict" }, "413": { description: "Canonical UTF-8 sync envelope exceeds 512 KiB" } } } },
    ...
    "/v3/account-data/adoption/start": { post: { description: "Start an authenticated, resumable adoption-v3 transfer session", requestBody: { required: true, content: { "application/json": { schema: { "$ref": "#/components/schemas/AdoptionTransferStart" } } } }, responses: { "200": { description: "Transfer session created or replayed idempotently" }, "400": { description: "Invalid transfer start" }, "401": { description: "Authentication required" }, "409": { description: "Generation or idempotency conflict" } } } },
    "/v3/account-data/adoption/{sessionId}/upload": { post: { description: "Upload one bounded adoption-v3 chunk; records and chunk metadata are stored separately", parameters: [{ "$ref": "#/components/parameters/AdoptionTransferSessionId" }], requestBody: { required: true, content: { "application/json": { schema: { "$ref": "#/components/schemas/AdoptionTransferUpload" } } } }, responses: { "200": { description: "Chunk accepted or replayed" }, "400": { description: "Invalid record, chunk, or fingerprint" }, "404": { description: "Transfer unavailable" }, "409": { description: "Duplicate, state, or idempotency conflict" }, "413": { description: "Canonical envelope or record limit exceeded" } } } },
    "/v3/account-data/adoption/{sessionId}/seal": { post: { description: "Seal a complete adoption-v3 transfer by canonical digest", parameters: [{ "$ref": "#/components/parameters/AdoptionTransferSessionId" }], requestBody: { required: true, content: { "application/json": { schema: { "$ref": "#/components/schemas/AdoptionTransferSeal" } } } }, responses: { "200": { description: "Transfer sealed or replayed" }, "400": { description: "Invalid seal" }, "404": { description: "Transfer unavailable" }, "409": { description: "Incomplete, stale, or mismatched seal" } } } },
    "/v3/account-data/adoption/{sessionId}/preview": { post: { description: "Build a resumable deterministic adoption-v3 preview using the existing merge semantics", parameters: [{ "$ref": "#/components/parameters/AdoptionTransferSessionId" }], requestBody: { required: true, content: { "application/json": { schema: { "$ref": "#/components/schemas/AdoptionTransferPreview" } } } }, responses: { "200": { description: "Preview ready" }, "400": { description: "Invalid or unsupported merge" }, "404": { description: "Transfer unavailable" }, "409": { description: "Preview or generation conflict" } } } },
    "/v3/account-data/adoption/{sessionId}/confirm": { post: { description: "Persist an immutable adoption-v3 decision fingerprint and exact conflict resolutions", parameters: [{ "$ref": "#/components/parameters/AdoptionTransferSessionId" }], requestBody: { required: true, content: { "application/json": { schema: { "$ref": "#/components/schemas/AdoptionTransferConfirm" } } } }, responses: { "200": { description: "Decision recorded or replayed" }, "400": { description: "Invalid confirmation" }, "404": { description: "Transfer unavailable" }, "409": { description: "Preview, decision, device, or resolution conflict" } } } },
    "/v3/account-data/adoption/{sessionId}/apply": { post: { description: "Materialize confirmed adoption into an invisible generation and atomically flip the active generation", parameters: [{ "$ref": "#/components/parameters/AdoptionTransferSessionId" }], requestBody: { required: true, content: { "application/json": { schema: { "$ref": "#/components/schemas/AdoptionTransferApply" } } } }, responses: { "200": { description: "Applied or resumed atomically" }, "400": { description: "Invalid apply request" }, "404": { description: "Transfer unavailable" }, "409": { description: "Generation, cursor, or decision conflict" } } } },
    "/v3/account-data/adoption/{sessionId}/status": { get: { description: "Read bounded resumable adoption-v3 status", parameters: [{ "$ref": "#/components/parameters/AdoptionTransferSessionId" }, { name: "deviceId", in: "query", required: true, schema: { type: "string", format: "uuid" } }], responses: { "200": { description: "Transfer status", content: { "application/json": { schema: { "$ref": "#/components/schemas/AdoptionTransferStatus" } } } }, "400": { description: "Invalid or mismatched device" }, "404": { description: "Transfer unavailable" } } } },
